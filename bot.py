...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Syungjinwooarc"), InlineKeyboardButton("Random Bot", url="https://t.me/Terminal_ShellBot")], [InlineKeyboardButton("Trash="https://t.me/binchzars"), [InlineKeyboardButton("Source Code", url="https://github.com/AbirHasan2005/Watermark-Bot")]]),
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [DEV](https://t.me/Sungjinwooarc).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
				...
				await cmd.message.edit(
					text="Something went Wrong. Contact my [Support Group](https://t.me/sungjinwooarc).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/sungjinwoo"), InlineKeyboardButton("Terminal in telegram", url="t.me/terminal_shellbot")]]),
			disable_web_page_preview=True
		)
		...
		if Config.UPDATES_CHANNEL:
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/sungjinwooarc).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
